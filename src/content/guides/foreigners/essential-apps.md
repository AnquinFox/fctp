...
![Phone Apps](/images/general/apps-phone.webp)

## Your Digital Toolkit

China runs on apps. Here's everything you need to download **before arriving**.
...
| App | Purpose | Notes |
|-----|---------|-------|
| **Amap (高德地图)** | Navigation | Best for driving, walking, metro |
| **Baidu Maps (百度地图)** | Navigation | Alternative to Amap |
| **Didi (滴滴)** | Ride-hailing | English interface available |
| **China Railway (铁路12306)** | Train tickets | Book high-speed rail tickets |
...
![Food Delivery](/images/general/apps-food.webp)
...
- **Minimum order**: Usually ¥15-25 ($2-3)
- **Delivery time**: 20-40 minutes
- **Payment**: WeChat Pay or Alipay only
- **Address**: Use Chinese characters (Amap can help)
- **Cash tip**: Not expected (but appreciated)
...
| App | Purpose | Notes |
|-----|---------|-------|
| **Baidu Translate (百度翻译)** | Translation | Best offline Chinese support |
| **WeChat (微信)** | Messaging | Built-in translation feature |
| **Pleco** | Dictionary | Best Chinese-English dictionary |
| **Google Translate** | Translation | Needs VPN to work |
...
![WeChat App](/images/general/apps-wechat.webp)

1. Download from App Store / Google Play
2. Register with your phone number (international OK)
3. Add a profile photo and name
4. Add friends by scanning their QR code
5. Set up WeChat Pay (see payment guide)
...
5. Start using mini-programs (see below)

### Amap Setup:

1. Download from App Store / Google Play
2. Allow location access
3. Set language to English (if available)
4. Download offline maps for your destination
5. Set home/work addresses
